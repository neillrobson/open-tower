...
class HouseType {
    ...
    public static final MASON = new HouseType(1, "Mason", 10, 8, 12, 0, 15, 0);
    ...
    public static final WINDMILL = new HouseType(7, "Miller", 8, 7, 13, 15, 15, 0);
    ...
    private function new(spriteIndex:Int, name:String, radius:Int, anchorX:Int, anchorY:Int, wood:Int, rock:Int, food:Int) {
